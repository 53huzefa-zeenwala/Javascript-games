...
export class Background {
    constructor(game) {
        ...
        this.layer2 = new Layer(game, this.width, this.height, 0.2, this.layer2image) 
        this.layer3 = new Layer(game, this.width, this.height, 0.4, this.layer3image) 
        this.layer4 = new Layer(game, this.width, this.height, 0.8, this.layer4image) 
